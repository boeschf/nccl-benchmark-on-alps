...
class AwsOfiNccl(AutotoolsPackage):
    ...
    version("1.6.0-hcopy", sha256="21dd16b8aa0ef756ad0686c658b8a8644b388b0e0759f83fd9820cf71feed208")
    ...
    variant("hcopy", default=True, when="@=1.6.0-hcopy", description="use gdrcopy")
    ...
    depends_on("gdrcopy", when="+hcopy", type=("build", "link", "run"))
    ...
    def configure_args(self):
        ...
        if spec.satisfies("+hcopy"):
            args.extend(["--with-gdrcopy={0}]".format(spec["gdrcopy"].prefix)])
